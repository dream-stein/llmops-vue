...
import { useGetPublishedConfig, useRegenerateWebAppToken } from '@/hooks/use-app.ts'
...
onMounted(() => {
  loadPublishedConfig(route.params?.app_id as string)
})
</script>
                ...
                <div class="flex items-center">
                  ...
                  <a-button
                    ...
                    @click="
                      async () => {
                        // 1.调用API接口发起请求
                        await handleRegenerateWebAppToken(route.params?.app_id as string)
